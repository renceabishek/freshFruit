...
function lowdbAction(type) {
            ...
            if (type == "savesend") {
                ...
                document.getElementById("inputSubject").value = "Bunker Delivery - BDN"+randomnumber+".json";
                document.getElementById("inputAttach").value = "Bunker Delivery"+randomnumber+".json";
