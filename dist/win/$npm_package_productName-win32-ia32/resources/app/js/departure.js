...
function lowdbDepAction(){
            ...
            var depdetails = { 
               ...
               db1.get('maildata').push(depdetails).write();
                ...
                document.getElementById("inputSubject").value = "Departure Report"+randomnumber+".json";
                document.getElementById("inputAttach").value = "Departure Report"+randomnumber+".json";
